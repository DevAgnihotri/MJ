...
let loop;  // game loop
let songName = 'MoonwalkDefault.mp3';  // name of the song
...
function generateWaveData() {
  ...
  let isIntroSong = songName === 'MoonwalkDefault.mp3';
...
// Function to initialize the game externally
function initGame() {
  if (typeof main === 'function') {
    main();
  } else {
    console.log('Starting game without main function');
    
    // Fallback initialization
    kontra.init();
    
    if (loadingScene && menuScene) {
      loadingScene.show();
      setTimeout(() => {
        loadingScene.hide();
        menuScene.show();
...
// Auto-start if not being called externally
